...
/**
 * Content handler to load Portable Pixmap files.
 ...
 */
public class x_portable_pixmap extends ContentHandler
{
   /**
    * Given a URL connect stream positioned at the beginning of the PPM
   ...
   public Object getContent(URLConnection u)
      throws IOException
   {
      // create a new image decoder ready to decode a PPM image
      ImageDecoder decoder = new ImageDecoder("x-portable-pixmap");
