...
/**
 * Content handler to load Portable GrayMap files.
 ...
 */
public class x_portable_graymap extends ContentHandler
{
   /**
    * Given a URL connect stream positioned at the beginning of the PGM
   ...
   public Object getContent(URLConnection u)
      throws IOException
   {
      // create a new image decoder ready to decode a PGM image
        ImageBuilder decoder = new ImageBuilder("x-portable-graymap");
