...
/**
 * Content handler to load Portable Network Graphics files.
 * Mime type: image/png
 * <P>
 *
...
{
   /**
    * Given a URL connect stream positioned at the beginning of the PNG
   ...
   public Object getContent(URLConnection u)
      throws IOException
   {
      // create a new image decoder ready to decode a PNG image
        ImageBuilder decoder = new ImageBuilder("png");
